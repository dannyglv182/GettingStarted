...
public class AboutEnums {
    ...
    public void enumsWithMethods() {
        assertEquals(OpticalMedia.CD.getCoolnessFactor(), (OpticalMedia.CD.capacityInMegaBytes - 1000) * 10);
        assertEquals(OpticalMedia.BluRay.getCoolnessFactor(), (OpticalMedia.BluRay.capacityInMegaBytes - 1000) * 10);
    }
}
