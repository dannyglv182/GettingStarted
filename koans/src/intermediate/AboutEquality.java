...
public class AboutEquality {
    ...
    static class Car {
        ...
        public boolean equals(Object other) {
            ...
            if (other != null && other.getClass() == getClass()){ Car car = (Car) other; return horsepower == car.horsepower && name == car.name;} else {return false;}
        }

        @Override
        public int hashCode() {
            // @see http://download.oracle.com/javase/6/docs/api/java/lang/Object.html#hashCode()
            return name.hashCode() + horsepower * 12;// return super.hashCode();
        }
    }
